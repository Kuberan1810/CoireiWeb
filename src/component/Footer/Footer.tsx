    ...
    return (
        <footer className={`mx-6 sm:mx-10 md:mx-15 pt-16 sm:pt-20 transition-colors duration-300 ${isFollei ? "bg-white text-black border-t border-black/10" : "bg-white  text-white"}`}>
            ...
            <div data-ns-animate data-offset="60" data-duration="1" data-direction="up" className="relative overflow-hidden">
                <span className={`pointer-events-none absolute top-0 left-0 h-px w-full bg-linear-to-r ${isFollei ? "from-transparent via-black/10 to-transparent" : "from-transparent via-white/30 to-transparent"}`} />
                <span className={`pointer-events-none absolute bottom-0 left-0 h-px w-full bg-linear-to-r ${isFollei ? "from-transparent via-black/10 to-transparent" : "from-transparent via-white/30 to-transparent"}`} />
                ...
                <div className="group flex items-center justify-between py-6">
                    ...
                    <a href="/careers" className={`flex items-center gap-2 text-xs sm:text-sm tracking-wide transition-all duration-300 ${isFollei ? "text-black/70 hover:text-black" : "text-white/70 hover:text-white"}`}>
                        JOIN OUR TEAM
                        <span className={`flex items-center transition-all duration-300 ease-out group-hover:translate-x-2 ${isFollei ? "text-black/40 group-hover:text-black" : "text-white/40 group-hover:text-white"}`}>
            ...
            <div className="py-5 sm:py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16">
                ...
                <div data-ns-animate data-delay="0.15" data-offset="80" data-direction="up" className="max-w-lg">
                    ...
                    <p className={`mt-4 text-sm sm:text-base ${isFollei ? "text-black/60" : "text-white/60"}`}>
            ...
            {/* BOTTOM */}
            <div data-ns-animate data-delay="0.2" data-offset="40" data-direction="up" className={`px-6 sm:px-8 py-6 flex justify-center md:justify-end text-xs sm:text-sm ${isFollei ? "text-black/50" : "text-white/50"}`}>
                © coirei
            </div>
