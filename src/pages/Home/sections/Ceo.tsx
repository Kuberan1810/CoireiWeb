...
const Ceo = () => {
    return (
        <section className="relative w-full my-12 md:my-20 overflow-x-hidden flex justify-center">
            ...
            <div className="relative z-10 max-w-[1200px] mx-auto w-full flex flex-col md:flex-row px-6 md:px-12 items-center md:items-end">
                ...
                <div className="w-full md:w-[60%] min-h-[180px] md:min-h-[200px] flex flex-col justify-center py-6 md:py-0">
