...
const IndustrialAITraining = () => {
  ...
  return (
    <section className="py-20 px-6 max-w-7xl mx-auto">
      <h2 data-ns-animate className="text-5xl md:text-6xl font-medium text-black mb-16">
      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center lg:items-center">
        ...
        <div data-ns-animate data-delay="0.1" className="w-full lg:w-[40%] flex flex-col pt-4">
          {courses.map((course, index) => (
            <div 
              key={index} 
              className={`py-5 flex justify-between items-center ${index !== courses.length - 1 ? 'border-b border-gray-50' : ''}`}
            >
