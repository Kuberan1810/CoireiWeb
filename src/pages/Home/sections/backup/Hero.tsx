                    ...
                    <div className="w-full xl:max-w-xl sm:text-start text-center">
                        ...
                        >
                            <button
                                ...
                                className="text-[#252525] py-2.5 px-4 bg-gray-200 rounded font-semibold border border-transparent hover:bg-[#1E1E1E] hover:text-white hover:border-white/10 transition-all duration-500 ease-out cursor-pointer sm:text-base text-[13px]"
                            >
                            ...
                            <button
                                ...
                                className="text-white py-2.5 px-4 bg-[#292929] rounded font-semibold border border-white/10 hover:bg-gray-200  hover:text-[#292929] transition-all duration-500 ease-out cursor-pointer sm:text-base text-[13px] "
                            >
