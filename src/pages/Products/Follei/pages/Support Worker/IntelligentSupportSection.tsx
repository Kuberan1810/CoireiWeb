                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="mb-4 text-center">
                        <h2 
                            data-ns-animate 
                            data-delay="0.1" 
                            className="text-[#0A0E29] font-medium text-[28px] sm:text-[36px] md:text-[48px] lg:text-[60px] leading-[1.2] md:leading-[1.1] tracking-tight md:tracking-[-1px]"
                        >
                        ...
                        <h2 
                            data-ns-animate 
                            data-delay="0.2" 
                            className="bg-gradient-to-r from-[#1079B7] via-[#8E2884] to-[#004370] bg-clip-text text-transparent font-medium text-[28px] sm:text-[36px] md:text-[48px] lg:text-[60px] leading-[1.2] md:leading-[1.1] tracking-tight md:tracking-[-1px]"
                        >
                            Never Stops
                        </h2>
                    </div>
