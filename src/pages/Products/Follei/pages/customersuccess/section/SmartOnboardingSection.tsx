      ...
      <div className="w-full flex flex-col items-center">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20 flex flex-col items-center">
          ...
          <h2 
            ...
            className="text-[#04032E] text-4xl sm:text-[60px] md:text-[52px] font-medium tracking-tight leading-[1.15] mb-4 max-w-none">
          ...
          <p 
            ...
            className="text-[#5A5A5C] text-base sm:text-[16px] font-normal leading-relaxed">
...
export default SmartOnboardingSection;
