...
export const AccountManagerMockup: React.FC = () => {
  ...
  return (
    <div ref={containerRef} className="solution-inner-card-wrapper floating-dashboard relative z-10 w-full h-full flex justify-center items-center p-4 sm:p-6 lg:p-10 scale-[0.65] sm:scale-75 md:scale-90 lg:scale-100 origin-center">
      {/* Custom Dashboard UI (Image Replication) */}
      <div className="w-[120%] sm:w-full h-full bg-white rounded-[16px] sm:rounded-[24px] relative shadow-lg flex flex-col justify-end px-4 sm:px-8 lg:px-12 pt-16 sm:pt-24 pb-4 sm:pb-8 overflow-hidden">
