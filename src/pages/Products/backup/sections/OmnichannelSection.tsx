...
const Card: React.FC<CardProps> = ({ title, description, icon, innerRef }) => {
    return (
        ...
        >
            <div className="w-full min-h-[180px] bg-white /60 backdrop-blur-xl border border-white/10 rounded-[20px] p-5 flex flex-col justify-between hover:border-[#3B82F6]/30 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)] transition-all duration-300 hover:-translate-y-1 group">
...
export const OmnichannelSection: React.FC = () => {
    ...
    return (
        <section
            ...
            className="relative w-full lg:h-screen lg:min-h-[660px] py-20 lg:pt-[90px] lg:pb-[30px] px-6 sm:px-10 md:px-15 overflow-hidden bg-white  flex items-center justify-center"
        >
