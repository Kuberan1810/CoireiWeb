...
const PrivacySection = () => {
  return (
    <section className="text-black GlobalPadding">
      {/* Hero */}
      <div
        data-ns-animate
        data-offset="80"
      ...
      >
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-tight text-center md:text-left max-w-4xl mx-auto md:mx-0 font-medium">
          Your privacy <br /> while using Coirei
        </h1>

        <p className="mt-6 text-base md:text-lg text-gray-700 max-w-3xl leading-relaxed text-left mx-auto md:mx-0 px-4 sm:px-0">
        ...
        <p className="mt-6 text-base md:text-lg text-gray-700 text-left mx-auto md:mx-0 px-4 sm:px-0">
        ...
        <div className="w-full flex flex-col md:flex-row gap-8 mt-8 flex-wrap px-4 sm:px-0">
          <div className="flex-1">
            <Settings className="text-[18px] bg-gray-100 text-gray-800 p-0.5 rounded-md mb-2.5" />
          ...
          <div className="flex-1 mb-6 md:mb-0">
            <Settings
              size={24}
              className="text-[18px] bg-gray-100 text-gray-800 p-0.5 rounded-md mb-2.5"
            />
            <p className="text-lg md:text-xl text-black font-medium mb-2">
      ...
      <div
        ...
        <h3 className="text-2xl md:text-3xl font-medium mb-4 text-black">
          How Coirei Works
        </h3>
        <p className="text-base md:text-lg text-gray-700 leading-relaxed">
      ...
      <div
        ...
        <p className="text-base md:text-lg text-gray-700 mb-2.5">
          Some Coirei features rely on cloud services to function correctly,
          including:
        </p>
        <ul className="text-base md:text-lg text-gray-700 space-y-2 list-disc list-inside">
        ...
        <p className="mt-2.5 text-base md:text-lg text-gray-700 leading-relaxed">
      ...
      <div
        ...
        className="max-w-4xl mx-auto mt-16 px-4 sm:px-0"
      >
        <h3 className="text-2xl md:text-3xl font-medium mb-4 text-black">Coirei AI</h3>
        <p className="text-base md:text-lg text-gray-700 leading-relaxed">
      ...
      <div
        ...
        className="max-w-4xl mx-auto mt-16 px-4 sm:px-0"
      >
        <h3 className="text-2xl md:text-3xl font-medium mb-2.5 text-black">Login</h3>
        <p className="text-base md:text-lg text-gray-700 leading-relaxed">
        ...
        <ul className="mt-2.5 text-base md:text-lg text-gray-700 list-disc list-inside space-y-2">
      ...
      <div
        ...
        className="max-w-4xl mx-auto mt-16 px-4 sm:px-0"
      >
        <h3 className="text-2xl md:text-3xl font-medium mb-2.5 text-black">
